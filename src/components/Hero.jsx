...
const Hero = () => {
  ...
  return (
    <main className="flex flex-col md:flex-row items-center justify-center h-svh w-screen order-1 gap-6" id="hero">
      <div className="flex flex-col gap-6 justify-center mx-3">
        <h1 className="~text-5xl/8xl font-black text-shadow">Hey, I'm Enes.</h1>
