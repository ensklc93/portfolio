                ...
                <div className="lg:py-16 px-4 mx-auto max-w-screen-sm lg:row-start-3 lg:col-start-8">
                    ...
                    <div className='flex gap-3 lg:flex-col'>
                        ...
                        <a className='grid place-items-center p-[1em] max-h-20 rounded-[10px] [box-shadow:6px_6px_10px_-1px_rgba(0,0,0,0.15),_-6px_-6px_10px_-1px_rgba(255,255,255,0.7)] border-[1px] border-solid border-[rgba(0,0,0,0)] cursor-pointer [transition:transform_0.5s] hover:[box-shadow:inset_4px_4px_6px_-1px_rgba(0,0,0,0.2),_inset_-4px_-4px_6px_-1px_rgba(255,255,255,0.7),_-0.5px_-0.5px_0px_rgba(255,255,255,1),_0.5px_0.5px_0px_rgba(0,0,0,0.15),_0px_12px_10px_-10px_rgba(0,0,0,0.05)] hover:border-[1px] hover:border-solid hover:border-[rgba(0,0,0,0.1)] hover:translate-y-[0.5em] *:hover:scale-[0.9] *:hover:rotate-[360deg] *:hover:fill-[#0092E4]' href='https://www.linkedin.com/in/ensklc' target='_blank'>
                            <svg id="linkedin" viewBox="0 0 24 24" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#333333" className='[transition:transform_0.5s] w-5 md:w-10 '>
                        ...
                        <a className='grid place-items-center p-[1em] max-h-20 rounded-[10px] [box-shadow:6px_6px_10px_-1px_rgba(0,0,0,0.15),_-6px_-6px_10px_-1px_rgba(255,255,255,0.7)] border-[1px] border-solid border-[rgba(0,0,0,0)] cursor-pointer [transition:transform_0.5s] hover:[box-shadow:inset_4px_4px_6px_-1px_rgba(0,0,0,0.2),_inset_-4px_-4px_6px_-1px_rgba(255,255,255,0.7),_-0.5px_-0.5px_0px_rgba(255,255,255,1),_0.5px_0.5px_0px_rgba(0,0,0,0.15),_0px_12px_10px_-10px_rgba(0,0,0,0.05)] hover:border-[1px] hover:border-solid hover:border-[rgba(0,0,0,0.1)] hover:translate-y-[0.5em] *:hover:scale-[0.9] *:hover:rotate-[360deg] *:hover:fill-[#0092E4]' href='https://x.com/EnesKilic_93' target='_blank'>
                            <svg id="twitter" viewBox="0 0 24 24" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#333333" className='[transition:transform_0.5s] w-5 md:w-10 '>
                        ...
                        <a className='grid place-items-center p-[1em] max-h-20 rounded-[10px] [box-shadow:6px_6px_10px_-1px_rgba(0,0,0,0.15),_-6px_-6px_10px_-1px_rgba(255,255,255,0.7)] border-[1px] border-solid border-[rgba(0,0,0,0)] cursor-pointer [transition:transform_0.5s] hover:[box-shadow:inset_4px_4px_6px_-1px_rgba(0,0,0,0.2),_inset_-4px_-4px_6px_-1px_rgba(255,255,255,0.7),_-0.5px_-0.5px_0px_rgba(255,255,255,1),_0.5px_0.5px_0px_rgba(0,0,0,0.15),_0px_12px_10px_-10px_rgba(0,0,0,0.05)] hover:border-[1px] hover:border-solid hover:border-[rgba(0,0,0,0.1)] hover:translate-y-[0.5em] *:hover:scale-[0.9] *:hover:rotate-[360deg] *:hover:fill-[#0092E4]' href='https://medium.com/@eneskilic_68976' target='_blank'>
                            <svg id="medium" viewBox="0 0 24 24" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#333333" className='[transition:transform_0.5s] w-5 md:w-10 '>
                        ...
                        <a className='grid place-items-center text-[0.5em] font-black p-[1em] max-h-20 rounded-[10px] [box-shadow:6px_6px_10px_-1px_rgba(0,0,0,0.15),_-6px_-6px_10px_-1px_rgba(255,255,255,0.7)] border-[1px] border-solid border-[rgba(0,0,0,0)] cursor-pointer [transition:transform_0.5s] hover:[box-shadow:inset_4px_4px_6px_-1px_rgba(0,0,0,0.2),_inset_-4px_-4px_6px_-1px_rgba(255,255,255,0.7),_-0.5px_-0.5px_0px_rgba(255,255,255,1),_0.5px_0.5px_0px_rgba(0,0,0,0.15),_0px_12px_10px_-10px_rgba(0,0,0,0.05)] hover:border-[1px] hover:border-solid hover:border-[rgba(0,0,0,0.1)] hover:translate-y-[0.5em] *:hover:scale-[0.9] *:hover:rotate-[360deg] *:hover:fill-[#0092E4]' href='mailto:eneskilic@mail.com' target='_blank'>
                            <svg id="email" viewBox="0 0 24 24" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#333333" className='[transition:transform_0.5s] w-5 md:w-10 '>
